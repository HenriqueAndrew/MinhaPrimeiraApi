...
import br.edu.utfpr.minhaprimeiraapi.databinding.ActivityItemDatailBinding
...
import br.edu.utfpr.minhaprimeiraapi.ui.loadUrl
...
class ItemDetailActivity : AppCompatActivity(), OnMapReadyCallback{
    ...
    private lateinit var binding: ActivityItemDatailBinding
    private lateinit var item: Item
    private lateinit var mMap: GoogleMap

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityItemDatailBinding.inflate(layoutInflater)
